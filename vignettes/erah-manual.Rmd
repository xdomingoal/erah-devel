...
devtools::install_github('xdomingoal/erah-devel',build_vignettes = FALSE)
```
...
The new experiment can then be created by loading the instrumental and phenotypic file paths into the workspace and supplying these to `newExp()` as below:

```{r experimentSetup,eval=FALSE}
#You may include the sep properly

instrumental <- 'experiment_path/PCOS/PCOS_inst.csv'
phenotype <- 'experiment_path/PCOS/PCOS_pheno.csv'
