#' @name mslib
#' @aliases mslib
#' @title MassBank Spectral Library
#' @description The default mass spectral library of eRah, which is the MassBank repository.
#' @usage data(mslib)
#' @details This is the eRah default MS library, and automatically loaded with the eRah package. It contains almost 500 MS spectra. For details, see reference below.
#' @references 
